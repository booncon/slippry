# Slippry ![Slippry build status](https://travis-ci.org/booncon/slippry.svg?branch=dev) [![CDNJS version](https://img.shields.io/cdnjs/v/slippry.svg)](https://cdnjs.com/libraries/slippry)
